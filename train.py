...
def main(batch, max_epochs, print_steps):  # epoch 8, step 3500 was stopping point
    model = CIFARModel()
    model.cuda()
    ...
    opt = optim.Adam(model.parameters(), lr=7e-4, weight_decay=1e-6)
    ...
    for epoch in range(max_epochs):
        for j, data in enumerate(train_loader, 0):
            ...
            # H0, C0 = [Variable(h0.data) for h0 in H0], [Variable(c0.data) for c0 in C0]
